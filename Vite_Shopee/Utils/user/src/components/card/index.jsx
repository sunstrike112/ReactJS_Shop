...
import { LESSON_TYPE, USER_ROLE, MY_PAGE_TABS } from '../../constants'
import { VoteLike, Watched, ClickAble, TextPrimary, ProgressSlider, Image } from '../index'
      ...
      >
        ...
        <div className="label-wrapper">
          <div className="label-course_vote">
            ...
            />
            <Watched
              voteNumber={course?.countOpenLesson}
            />
          </div>
          {renderLabel()}
        </div>
