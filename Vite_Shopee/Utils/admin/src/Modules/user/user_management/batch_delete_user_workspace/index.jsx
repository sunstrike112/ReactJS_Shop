...
import { useDeleteByCsv } from 'Hooks'
import {
  Wrapper
} from './styled'
          ...
          <div>
            <Space>
              <Button
                ...
                onClick={() => downloadOctetFile({ fileName: `delete-user-ws-${language}.csv`, downloadPath: END_POINT.USER.DOWNLOAD_CSV_TEMPLATE, baseUrl: DOWNLOAD_CSV })}
              >
...
export default BatchWSDeleteUserScreen
