...
export default (t) => yup.object().shape({
  ...
  contentQuestionHtml: yup.string().trim()
    ...
    .max(5000, t('error_message:validation.max_length', { key: t('create.question_text'), max: 5000 })),
  ...
  description: yup.string().trim()
    .max(10000, t('error_message:validation.max_length', { key: t('create.explanation'), max: 10000 }))
  // imagePath: yup.mixed()
