...
import { FormInput, FormRangePickerV2, FormSelect, FormTreeSelect, HeaderSearch } from 'Components'
import { useGroupAttribute, useMyCompany, useUnitLearnCourseStatus } from 'Hooks'
...
const FilterBlock = ({ setSortInfo, sortParams, isSuperAdmin, companyAll, setRowSelected }) => {
  ...
  }, [pageSize, isSuperAdmin, DEFAULT_VALUES, valueOfNissokenCompany])
