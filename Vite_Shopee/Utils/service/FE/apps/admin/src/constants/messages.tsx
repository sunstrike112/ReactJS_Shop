...
export const ERROR_MESSAGE_INVALID_CONFIRM_PASSWORD = 'The confirmed password is not matched. Please try again.'
...
export const ITEM_CREATED_SUCCESSFULLY = 'Item has been successfully created'
...
export const DISCARD_CHANGES_MESSAGE_CONFIRM = 'Are you sure you want to discard all changes?'
