---
to: apps/api/src/<%= type %>/<%= name %>/interceptors/<%=name%>-req.interceptor.ts
---
...
@Injectable()
export class <%= h.changeCase.pascal(Name) %>ReqInterceptor<T> implements NestInterceptor<Partial<T>, T> {
